...
const dialogue = " سلام... من نازی‌ام (ملقب به هیتلر 😁). من توی دنیایی هستم که کتابامو توش گم کرم... کمکم کن 124 تا کتابمو پیدا کنم تا از این دنیا خلاص بشم.... راستی مراقب باش کتاب ها پایین نیفته یا به اشک ها برخورد نکنی چون کارمون خیلی سخت میشه...";
let index = 0;
